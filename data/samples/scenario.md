...
リミット増加用オブジェクトがある場合、 人数分の食料を消費し、誰か1人が指定特技《休む／環境7》の判定に成功することでリミットを1増加させることができます。
...
二回、前足をかくと、＜ヌシ＞は 闘牛の牛よろしくPCたちに突撃してきます。
...
報酬として、各キャラクターは9J以下のアイテムを１つ獲得できます。また、3点のCPをキャンプは獲得します。
