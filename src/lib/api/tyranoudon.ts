...
${tags}
${partsTags}
[macro name="chara_parts_set_gon_normal"]
[chara_part_reset name="gon"]
[endmacro]
[macro name="chara_parts_set_gon_mask"]
[chara_part_reset name="gon"]
[chara_part name="gon" option="仮面" ]
[endmacro]

@chara_parts_set_gon_mask
@chara_show name="gon"
[s]
`
  } catch (e) {
...
const getCharacterParts = async (spreadId) =>
